...
CREATE EXTENSION IF NOT EXISTS "basejump-supabase_test_helpers" WITH SCHEMA "public";
...
CREATE TYPE "authenticated"."organization_type" AS ENUM (
    'club',
    'college'
);


ALTER TYPE "authenticated"."organization_type" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "authenticated"."handle_new_user"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'authenticated'
    AS $$
begin
  insert into authenticated.profiles_v0 (id, email)
...
ALTER FUNCTION "authenticated"."handle_new_user"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "authenticated"."verify_email_domain"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
...
ALTER FUNCTION "authenticated"."verify_email_domain"() OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "authenticated"."handle_new_user"() TO "authenticated";
GRANT ALL ON FUNCTION "authenticated"."handle_new_user"() TO "service_role";



GRANT ALL ON FUNCTION "authenticated"."verify_email_domain"() TO "authenticated";
GRANT ALL ON FUNCTION "authenticated"."verify_email_domain"() TO "service_role";
